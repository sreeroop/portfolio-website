...
export default function Home() {
  ...
  return (
    <>
      ...
      <AppBar sx={{ position: 'fixed', left: 0, top: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '10vh', width: '100vw' }}>
      ...
      <Grid container sx={{ display: 'flex', flexDirection: 'column', maxWidth: '100vw', overflowX: 'hidden' }}>
        <Grid item sx={{ minHeight: '100vh', position: 'relative' }}>
          <Landing />
